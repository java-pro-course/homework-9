...
public class Main {
    ...
    public static void main(String[] args) {
        Student student = new Student("Oleg", "Korsar", "Evgenievich", "male", 2009, 56, "Colledge", "24A", "math");
        Employee employee = new Employee("Ivan", "Matrosov", "Sergeevich", "male", 1998, "Sberbank", "analitic manager", 10000, "Monday")
            student.getInfo();
            employee.getInfo();
    }
}